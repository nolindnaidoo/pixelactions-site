...
are capped at four (README.md says why). Pages about pixelactions itself are
...
- **CodeQL default setup must stay off.** This repo runs the advanced workflow
  ...
  ```bash
  gh api repos/nolindnaidoo/pixelactions-site/code-scanning/default-setup --jq .state
