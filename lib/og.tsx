...
// click path drawn as inline SVG (Satori renders svg elements; CSS here
// is flexbox-only), a run-report JSON line for the thesis, and a Rust
...
function ClickPath() {
  return (
    ...
    >
      <polyline
        points="40,30 160,120 60,220 130,320"
        stroke={BLUE}
        strokeWidth="3"
        strokeDasharray="10 8"
      />
      <circle cx="40" cy="30" r="8" fill={GREEN} />
      <circle cx="160" cy="120" r="8" fill={GREEN} />
      <circle cx="60" cy="220" r="8" fill={GREEN} />
      <circle cx="130" cy="320" r="9" fill={GREEN} />
      <circle cx="130" cy="320" r="20" stroke={GREEN} strokeWidth="3" />
      <circle cx="130" cy="320" r="32" stroke={GREEN} strokeWidth="2" opacity="0.5" />
    </svg>
  )
}
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', marginTop: 28, color: GREEN, fontSize: 22 }}>
          {'{ "outcome": "verified", "points": [{ "x": 812, "y": 440 }] }  # exit 0'}
        </div>
        <div
          style={{
            position: 'absolute',
