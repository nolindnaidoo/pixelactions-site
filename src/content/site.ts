...
/** The binary's name. Shared components read this rather than spelling it —
 * this scaffold is copied between the two tools, and a hardcoded name ships
 * the wrong one silently. */
export const TOOL_NAME = 'pixelactions'
export const TOOL_VERSION = '0.9.7'
...
/** The one line of tool output on the Open Graph card. pixelactions reports
 * an outcome, not a coordinate — that distinction is the whole product. */
export const OG_SAMPLE = '{ "summary": "click submit", "outcome": "verified" }'
