...
export const metadata: Metadata = {
  ...
  description:
    'Execute desktop interactions from a pixelcoords session: click, type, and drag by label — re-located before acting, verified after, refused rather than guessed. Drivable by a model over MCP. Free, MIT. macOS, Windows, and Linux.',
}
