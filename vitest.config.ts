  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'scripts/build-og.ts',
        // Its `main` diffs two whole build trees, so it cannot run in this
        // process. The extractors it is built from — visibleText, extract,
        // compare, normalise, strip — are covered. This gate is temporary and
        // goes at the swap, when there is nothing left to compare against.
