    ...
    <VsPage
      ...
      verdict={
        <p>
          ...
          comes close, and pixelactions is not there yet: today it runs on macOS and on Linux, both
          X11 and Wayland (GNOME and KDE), with Windows next. The difference is one of kind, not
          depth. AutoHotkey is a language you write; pixelactions is deliberately not a language — a
          list of steps over regions a human marked in pixelcoords, re-located against a fresh
          capture and verified at run time, with loops and branching left to whatever language you
          already write, over the line protocol. If your automation is a program, AutoHotkey gives
          you its language; pixelactions gives your language an executor.
        </p>
      }
      whenThem={[
      ...
      whenUs={[
        'You are on macOS or Linux — where pixelactions runs today.',
