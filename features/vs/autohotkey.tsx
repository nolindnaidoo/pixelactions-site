...
export function AutohotkeyPage() {
  return (
    <VsPage
      ...
      framing="A Windows institution against a cross-platform list of steps — the comparison is one of kind, not of platform."
      verdict={
        <p>
          ...
          comes close on depth. pixelactions runs on Windows too now, alongside macOS and Linux (X11
          and Wayland), so the honest difference is no longer the platform line — it is one of kind.
