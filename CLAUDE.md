...
One job: convince someone that pixelactions — which consumes human-marked
coordinates, performs the interaction, and confirms it landed — is worth
installing, and get out of the way.
...
- **Claims must match the tool.** Every version, feature and platform
  statement here is checked against pixelactions's README and docs. A site that
